...
public class Launch6 {
	public static void main(String[] args) {
		...
		// specific multi - Catch
			...
			System.out.println("Arthimetic Exception was genrated and handled or+"InputMismatchException was genrated and handled");
		}
		
		catch(NegativeArraySizeException|ArrayIndexOutOfBoundsException ae) {
			System.out.println("NegativeArraySizeException was genrated and handled or");
		}
