...
public class Launch5 {
	public static void main(String[] args) {
		...
		// specific Catch
			...
			System.out.println("Arthimetic Exception was genrated and handled");
		}
		catch(InputMismatchException ime) {
			System.out.println("InputMismatchException was genrated and handled");
		}
		catch(NegativeArraySizeException nae) {
			System.out.println("NegativeArraySizeException was genrated and handled");
		}
		catch(ArrayIndexOutOfBoundsException aie) {
			System.out.println("ArrayIndexOutofBoundsException was genrated and handled");
		}
